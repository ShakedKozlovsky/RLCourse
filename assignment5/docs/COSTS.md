...
| **TOTAL** | — | **57 turns** | **~524 k** | **~154 k** | **$7.86** | **$11.55** |

## 3. Headline cost

| | |
|---|---|
| Total input tokens | ~524 000 |
| Total output tokens | ~154 000 |
| **Total cost** | **~$19.41** (USD) |
| Per-layer average | ~$1.14 |
| Per delivered source LOC (~2 600 LOC across src/ + tests/) | **~$0.0075 / line** |
