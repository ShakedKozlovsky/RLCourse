...
from proximal_lab.shared.version import __version__


def _project_root() -> Path:
    """Resolve the assignment4/ root from this file's location."""
...
class ConfigManager:
    ...
    def __init__(self, setup_path: Path | None = None):
        setup_path = setup_path or Path(
            os.environ.get("PROXIMAL_LAB_CONFIG", DEFAULT_SETUP_PATH)
        )
